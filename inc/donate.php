<script type="text/javascript" id="bloomerangForm205824"></script>
<pre><script type="text/javascript">
    var insertForm205824 = function() {
        var html205824 = '<style text=\'text/css\'>' + 
...
'<label for="consent-all"><input id="consent-all" name="consent-all" type="checkbox" maxlength="255"></input><span class="label">I would like to receive or continue receiving updates from Heart Math Tutoring</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha205824"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml205824 = '\u003cscript\u003ewindow.location.replace(\'http://hearttutoring.org/thank-you-for-your-donation/\')\u003c/script\u003e';( function($) {if (Bloomerang.useDonationId('205824')) { 
                                    Bloomerang.useProcessor('143360', 'Spreedly', 'OqOMv1ksjPtXEYHtCYsVXzEpCbR');
                                } else {
                                    html205824 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                                }if (jQuery('#bloomerangForm205824').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html205824 = '<p style="color: red">​Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade ​your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm205824').after(html205824);
                                            ...
                                            Bloomerang.Util.load('https://core.spreedly.com/iframe/express-2.min.js', 
                                                ...
                                                function() {
                                                    ...
                                                    Bloomerang.initSpreedly = function() {
                                                        SpreedlyExpress.init('OqOMv1ksjPtXEYHtCYsVXzEpCbR', { 'company_name': 'Heart Math Tutoring' });
                                                    };
                       ...
                       window.captchaLoadCallback = function() {
                        ...
                        Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                            ...
                            function() {
                                ...
                                jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha205824', { 'sitekey' : '6Lekur4UAAAAAJQSX22uMkVVqtmH7bKqEUlIxjnI' }));
                            },
                            true,
                            true);
                    Bloomerang.transactionFee = 0.2; Bloomerang.transactionFeeRate = 0.025; Bloomerang.transactionFeeEft = 0.2
                    Bloomerang.useKey('pub_708e64c6-1675-11e4-a756-02a718d18e56');
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml205824);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidation(function() { insertForm205824(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidation(function() { insertForm205824(); })});
                    }
